...
class PUIdata extends StatelessWidget {
  ...
  final List tasks = [
    {"title":"Report Case 1", "completed": true},
    {"title":"Blog Page Case 2", "completed": false},
    {"title":"Untitle", "completed": false},
    {"title":"Untitle", "completed": false},
  ];
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                Text("Hey, Sahan", style: TextStyle(
                    color: Colors.white,
                    fontSize: 28.0,
                    fontWeight: FontWeight.w700
                ),),
                SizedBox(height: 10.0),
                Text("You can\nContribute Here.....", style: TextStyle(
                    color: Colors.white,
                    fontSize: 18.0
                ),)
              ],
