                ...
                <View style={{ flex: 1 }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 10 }}>
                        <View style={{ flexDirection: 'row' }}>
                            <Ionicons name='ios-heart-empty' size={24} color='#73788B' style={{ marginRight: 10 }} />
                            <Ionicons name='ios-chatboxes' size={24} color='#73788B' />
                        </View>
                        <TouchableOpacity onPress={() => {
                            let shareText = ""
                            shareText += "author: " + post.name + "\n"
                            shareText += "description: " + post.text + "\n"
                            shareText += "image: " + post.image + "\n"
                            Share.share(
                                {
                                    message: shareText
                                })
                            ...
                            <Ionicons name='ios-share-alt' size={24} color='#73788B' />
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
